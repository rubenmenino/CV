...
lightSources[0].setPosition( 0.0, 1.0, 150.0, 1.0 );

lightSources[0].setIntensity( 1.0, 1.0, 1.0 );

lightSources[0].setAmbIntensity(0.0, 0.0, 0.2);
...
lightSources[1].setPosition(0.0, -1, -150.0, 1.0);

lightSources[1].setIntensity( 1.0, 0.0, 1.0 );

lightSources[1].setAmbIntensity( 0.0, 0.0, 0.2 );


// Light source 3 : white, rotating from bottom to top



lightSources.push( new LightSource() );

lightSources[0].setPosition( -100, 0.0, 0.0, 1.0 );
